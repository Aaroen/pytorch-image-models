...
group.add_argument('--class_map', default='', type=str, metavar='FILENAME',
                   help='path to class to idx mapping file (default: "")')
group.add_argument('--input_img_mode', default=None, type=str,
                   help='Dataset image conversion mode for input images.')
group.add_argument('--input_key', default=None, type=str,
                   help='Dataset key for input images.')
group.add_argument('--target_key', default=None, type=str,
